...
const PrivacyPage = () => {
  return (
    <ScrollBarProgress>
      <div className="w-full mx-w-[90rem] overflow-hidden">
        <section className="flex h-[300px] md:h-[350px] w-full flex-col items-center justify-center">
          <div>
            <h1 className="h1_bold">Privacy Policy</h1>
          </div>
        </section>
        <div className="lg:mx-auto flex xl:max-w-7xl mb-20 flex-col gap-y-8 md:gap-y-12 mx-3 sm:max-w-md md:max-w-2xl lg:max-w-5xl">
          <p className="text-base text-[#F5F5F5] font-light sm:text-lg md:text-xl lg:text-2xl ">
            Cloudprism respects the intellectual property rights of others and
            expects our users and employees to do the same. Our copyright policy
            is designed to ensure that we are in compliance with all applicable
            copyright laws and regulations, while also protecting the original
            content created by our company.
          </p>

          <div className="flex w-full flex-col gap-y-4">
            <h2 className="h2_semibold lg:!text-4xl">
          ...
          <div className="flex w-full flex-col gap-y-4">
            ...
            <p className="text-base text-[#F5F5F5] font-light sm:text-lg md:text-xl lg:text-2xl ">
              All original content created by SFCPRISMS Solutions Pvt Ltd,
          ...
          <div className="flex w-full flex-col gap-y-4">
            <h2 className="h2_semibold lg:!text-4xl">Permissions</h2>
            <p className="text-base text-[#F5F5F5] font-light sm:text-lg md:text-xl lg:text-2xl ">
