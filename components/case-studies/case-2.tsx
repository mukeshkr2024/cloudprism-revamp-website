              ...
              <div className="mt-8 flex flex-col gap-y-6">
                ...
                >
                  <div className="flex flex-col gap-y-4">
                    ...
                    <p className="blog_paragraph">
                      By overcoming challenges we implemented our solutions that
                      are affecting paypal business
                    </p>
                    ...
                    <ul className="flex flex-col gap-y-2 ">
                      ...
                      <li className="blog_paragraph">
                        ...
                        realtime tracking of payments were improved so the data
                        Generated by process will be efficient.
                      </li>
                    </ul>
                  </div>
                  <div className="flex flex-col gap-y-4">
