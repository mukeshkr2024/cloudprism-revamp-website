...
export default function OurClientSay() {
  return (
    <div
      className="mx-auto flex h-[520px] w-full max-w-[95rem] flex-col justify-center  bg-cover bg-center text-white sm:h-[600px] md:-mt-36 md:h-[700px] lg:h-[800px] xl:h-[950px]"
      style={{
