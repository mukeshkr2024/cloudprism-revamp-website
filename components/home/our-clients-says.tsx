...
export default function OurClientSay() {
  return (
    <div
      className="mx-auto flex h-[520px] w-full max-w-[95rem] flex-col justify-center  bg-cover bg-center text-white sm:h-[600px] md:-mt-28 md:h-[700px] lg:h-[800px] xl:h-[950px]"
      style={{
    ...
    >
      <div className="mx-auto flex max-w-[310px] flex-col gap-y-10   sm:max-w-md  sm:gap-y-12 md:max-w-2xl  md:gap-y-14 lg:max-w-[850px] lg:gap-y-20 xl:gap-y-24">
        <h3 className="h2_semibold text-center xl:!text-6xl ">
